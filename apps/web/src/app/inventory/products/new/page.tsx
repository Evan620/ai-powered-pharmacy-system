  ...
  const createMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      if (!profile?.pharmacy_id) {
        throw new Error('No pharmacy ID found. Please ensure you have a valid profile.');
      }
    ...
    onError: (error: any) => {
      ...
      } else if (error.message.includes('pharmacy ID')) {
        setErrors({ general: 'Profile setup incomplete. Please contact support.' });
      ...
      <AppShell>
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <h1 className="text-lg font-semibold mt-1">Add New Product</h1>
          </div>
